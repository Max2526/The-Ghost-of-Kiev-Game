let ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		for (let k = 0; k < txtList.length; k++) {
			let t = txtList[k], tl = t.split(" ");
	...
	ytAboutLayer.prototype.addBtn = function () {
		...
		let backTxt = new LTextField();
		backTxt.color = "white";
		backTxt.size = 20;
		backTxt.text = "Back to Menu";
		backTxt.weight = "bold";
		let backBtn = new ytButton(2, [backTxt, "center", "middle"], [0.6, 0.6]);
